...
const HeaderMainContent = () => {
  return (
    <div className="flex gap-6 text-white pb-20 ">
      <div className="bg-txt flex-1 p-12 rounded-2xl flex flex-col justify-center gap-8 max-xl:items-center">
        <div className="flex flex-col gap-3 max-xl:items-center">
          ...
          <h1 className="font-morabba-bold text-6xl relative flex max-[630px]:text-3xl">
            ...
            <ImLeaf className="text-green-600 text-4xl rotate-y-180 absolute left-8 max-xl:-left-2 max-xl:text-3xl" />
          </h1>
        </div>
      ...
      <div className="bg-[#847669] opacity-90 p-20 flex-3 flex items-center relative min-h-100 rounded-2xl overflow-hidden  max-[630px]:m-5  max-[630px]:min-h-50">
        <div className="flex flex-col  gap-8  ">
          ...
          <a href="#">
            <FaArrowLeftLong className="text-2xl max-xl:text-xl" />
          </a>
        </div>
        <img
          src="/images/hands.png"
          alt="hands"
          className="absolute left-0 bottom-0 z-10 max-xl:w-100 max-xl:h-80"
        />
