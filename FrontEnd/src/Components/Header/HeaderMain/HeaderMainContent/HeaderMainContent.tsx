...
const HeaderMainContent = () => {
  return (
    <div className="flex gap-6 text-white pb-20 max-lg:relative">
      <div className="bg-txt flex-1 p-12 rounded-2xl flex flex-col justify-center gap-8 max-xl:items-center max-xl:px-8 max-xl:gap-12 max-lg:min-h-175 max-lg:justify-start max-lg:gap-3 max-md:min-h-140 max-sm:min-h-122 max-sm:w-fit max-sm:gap-2">
        <div className="flex flex-col gap-3 max-xl:items-center">
          ...
          <h1 className="font-morabba-bold text-6xl max-xl:text-4xl relative flex max-lg:text-6xl max-md:text-4xl max-sm:text-3xl">
      ...
      <div className="bg-[#847669] opacity-90 p-20 flex-3 flex items-center relative min-h-100 rounded-2xl overflow-hidden max-lg:absolute max-lg:w-11/12 max-lg:left-1/2 max-lg:-translate-x-1/2 max-lg:bottom-35 max-md:min-h-80 max-sm:min-h-10 max-sm:p-15">
        <div className="flex flex-col  gap-8  ">
          <h2 className="font-morabba-bold text-5xl max-xl:text-4xl max-sm:text-xl">
      ...
      <div className="absolute bottom-24 left-125 max-2xl:left-88 max-xl:left-85  max-xl:-translate-1/2 max-lg:left-1/2 flex gap-2 max-md:bottom-25">
      ...
      <Button className="cursor-pointer right-113 top-1/2 translate-y-1/2 absolute text-4xl max-lg:bottom-85 max-lg:right-12 hover:right-8 transition-transform 
      max-xl:right-86 max-md:bottom-75 max-md:hover:right-12 max-sm:bottom-70 max-sm:right-5">
        <BsChevronRight />
      </Button>
