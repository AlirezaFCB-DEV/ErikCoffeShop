...
const Training_Items = () => {
  return (
    <div className=" w-full h-full flex flex-col items-center gap-24 absolute top-30 px-16 max-lg:px-20 max-lg:gap-16 max-sm:px-4">
      <div className="flex gap-8 max-xl:overflow-x-scroll min-h-max py-6 px-3  max-xl:w-[100%] max-sm:px-2 ">
        ...
        <Button className="xl_size_training_btns right-8 max-sm:right-0" type="button" >
          <BsChevronRight className="text-4xl"/>
        </Button>
        <Button className="xl_size_training_btns left-8 max-sm:left-0" type="button" >
