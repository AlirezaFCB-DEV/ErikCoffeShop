        ...
        <div className="flex  justify-between  h-full max-lg:px-6">
          <div className="flex justify-center">
            <Button className="cursor-pointer text-primary gap-4 transition-colors flex justify-center text-center items-center relative">
              <span className="transition-colors text-sm max-lg:text-lg">
                مشاهده بیشتر
              </span>
          ...
          <div>
            <h3 className="font-iran-yekan-bold text-sm text-sec-text max-lg:text-lg">
              {date}
            </h3>
          </div>
        </div>
